...
| 参考名称 | 链接 | 参考点 |
| --- | --- | --- |
| 量子元素周期表 | https://chiantera.github.io/quantum-periodic-table/ | 背景、UI、视角操作和交互逻辑 |
| WebGPU Compute Particles | https://threejs.org/examples/?q=par#webgpu_compute_particles | 大规模粒子渲染、基础交互响应、性能优化、展开蚀刻时的自由交互 |
